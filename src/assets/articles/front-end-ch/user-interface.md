...
如果用戶未登入，主功能有儀表板頁面、地圖頁面可以使用，展示公共儀表板和組件。若使用者想快速了解與自身需求相關的組件，可使用畫面右下角的小幫手。

![未登入的用戶界面儀表板頁面](/images/front-end/user-interface-1.png)

點擊小幫手按鈕，展開聊天室視窗後，使用者可直接輸入感興趣的主題，將由小幫手協助篩選出相關組件，並以表格呈現篩選結果。

![未登入用戶小幫手使用示意](/images/front-end/user-interface-1-1.png)
...
已登入用戶使用右下角的小幫手，除了能詢問特定主題的相關組件外，還能夠點擊「建立儀表板」，將由小幫手自動彙整推薦組件至推薦儀表板，並新增至您的個人儀表板當中。

![已登入用戶小幫手使用示意](/images/front-end/user-interface-2查詢向量資料庫，輸入關鍵字-1.png)

export const en = {
	...
	"back-end": {
		...
		"issues-db": "Issues DB",
		"contributors-db": "Contributors DB",
		"viewpoints-db": "Viewpoints DB",
		"chatlog-db": "Chatlog DB",
		...
		"contributor-apis": "Contributor APIs",
	...
	"data-end": {
		name: "Data End",
		desc: "Data extraction, transformation, loading, etc.",
		"#getting-started": "Getting Started",
		introduction: "Introduction",
		prerequisites: "Prerequisites",
		"project-setup": "Project Setup",
		"#project-structure": "Project Structure",
		dataend: "Data End Overview",
		airflow: "Airflow Overview",
		database: "Database Overview",
		"#basic": "Basic DAG Development",
		"global-config": "Global Variable",
		"dag-metadata": "DAG Metadata",
		"dag-code": "DAG Code",
		"dag-config": "DAG Config",
		"dag-table": "DAG Table",
		"dag-test": "DAG Testing",
		"#advanced": "Advanced",
		"pipeline": "Custom Pipeline",
		"utils-overview": "Utility Functions Overview",
		"utils-generate-sql": "Utility Functions - Create Table",
		"utils-extract": "Utility Functions - Extract",
		"utils-transform-time": "Utility Functions - Transform Time",
		"utils-transform-spatial": "Utility Functions - Transform Spatial",
		"utils-transform-address": "Utility Functions - Transform Address",
		"utils-load": "Utility Functions - Load",
		"utils-tdx": "Utility Functions - TDX token",
		"#contribution-guide": "Contribution Guide",
		"contribution-overview": "Contribution Overview",
		"code-style": "Code Style",
		"open-an-issue": "Open an Issue",

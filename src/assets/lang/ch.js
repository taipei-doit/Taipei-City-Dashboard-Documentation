export const ch = {
	...
	"data-end": {
		...
		"dag-test": "資料流測試",
		"#advanced": "進階",
		"pipeline": "客製 Pipeline",
		"utils-overview": "通用函式概覽",
		"utils-generate-sql": "通用函式-建表",
		"utils-extract": "通用函式-抽取階段",
		"utils-transform-time": "通用函式-轉換階段-時間",
		"utils-transform-spatial": "通用函式-轉換階段-空間",
		"utils-transform-address": "通用函式-轉換階段-地址",
		"utils-load": "通用函式-儲存階段",
		"utils-tdx": "通用函式-TDX token",
		"#contribution-guide": "協作指南",
		"contribution-overview": "協作方式概覽",
		"code-style": "程式撰寫規範",
		"open-an-issue": "開立 Issue",
		"open-a-pull-request": "開立 Pull Request",
	},
};
